...
## Case 2: using public key authentication
...
4. *Setup your server container exactly as described for [Case 1](#setup-server-container)

### Setup client container

For this case, the client container has a few extra steps, that will allow us to connect through a public/private key pair.
...
Here you can choose a password that will be used for your ssh connections instead of the server user's password as in case 1.
...
You can see the files in the server to play with the connection just as in case 1
